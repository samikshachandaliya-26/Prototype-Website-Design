...
export function TestimonialsMinimal() {
  ...
  useEffect(() => {
    const timer = window.setInterval(() => {
      ...
      // setActive drives desktop/tablet cross-fade directly
      setActive(next);
      // scrollToIndex syncs the mobile scroll strip (no-op when hidden/display:none)
  ...
  return (
    <div ref={rootRef} className="w-full max-w-4xl py-0 md:py-16">
      ...
      <div className="mb-0 w-full md:mb-12">
        <div
          className="hidden w-full items-center justify-start gap-3 md:flex"
          onMouseEnter={() => { pauseUntilRef.current = Date.now() + 60_000; }}
          onMouseLeave={() => { pauseUntilRef.current = Date.now() + AUTO_MS; }}
        >
              ...
              >
                <img
                  ...
                  className={`
                    ...
                    sm:h-11 sm:max-h-11
                    transition-[filter,opacity] duration-[400ms] ease-[cubic-bezier(0.22,1,0.36,1)]
                    object-center
        ...
        {testimonials.map((t, i) => (
          <p
            ...
            className={`
              ...
              transition-[opacity,transform] duration-[500ms] ease-[cubic-bezier(0.22,1,0.36,1)]
              ${
                active === i
        ...
        {testimonials.map((t, i) => (
          <div
            ...
            className={`
              ...
              transition-[opacity,transform] duration-[500ms] delay-[60ms] ease-[cubic-bezier(0.22,1,0.36,1)]
